 ...
 * Accepts the same JSON shape as the Python ActivityLogEntry model,
 * plus the optional `page_url` and `session_id` top-level fields.
 */
router.post("/", async (req, res) => {
  try {
    ...
    // Pull page_url / session_id from top-level or metadata
    const page_url =
 ...
 * GET /logs/health
 *
 * Quick liveness probe for the logging service.
 */
